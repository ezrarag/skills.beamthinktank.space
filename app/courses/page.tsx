...
const courses = [
  ...
  },
  {
    ...
    level: "Intermediate",
    featured: true,
    imageUrl: "https://sdyyvwazlkcihsrivnff.supabase.co/storage/v1/object/public/Courses/Static%20Card%20assets/pexels-khwanchai-4161619.jpg",
    videoUrl: null,
  ...
  },
  {
    ...
    level: "Beginner",
    featured: false,
    imageUrl: "https://sdyyvwazlkcihsrivnff.supabase.co/storage/v1/object/public/Courses/Static%20Card%20assets/pexels-juanpphotoandvideo-1246437.jpg",
    videoUrl: null,
  ...
  {
    id: 26,
    title: "International Construction & Sustainable Development",
    description: "This course introduces participants to global approaches in construction, from traditional methods to modern sustainable building practices. Learners will explore how construction standards differ across regions, how to integrate local resources, and how BEAM's development ecosystem ties into global real estate and community building projects.",
    category: "Design & Built Environment",
    price: "Free (unlocked through community donations)",
    duration: "8 weeks (2 hrs / session)",
    students: 0,
  ...
  {
    id: 27,
    title: "Beautification & Entrepreneurship",
    description: "This course introduces participants to the fundamentals of personal care services (hair, nails, lashes, skincare, and beauty products), combined with entrepreneurial skills to run a small business. Students will learn not only the techniques but also how to create a sustainable client base, navigate product sourcing, and align with BEAM's local economic development ecosystem.",
    category: "Business & Finance",
    price: "Free (unlocked through community donations)",
    duration: "8 weeks (2 hrs / session)",
    students: 0,
